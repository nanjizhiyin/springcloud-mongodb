 ...
 *
 * @className com.xuexin.xcloud.dictionary.entity.DicSubject
 * @version v1.0.0 
 * @author zhangjingsi
 * 
 ...
 * 
 * @author zhangjingsi
 * @date 2017-06-21 13:26:26
 */
public class DicSubject implements Serializable {

    private Integer subjectID;//学科ID
    private String subjectName;//学科名称
    private Integer phaseID;//所属学段
	private String phaseName;//学段名称
	private Integer subjectPID;//父级学科
    private String classIcon;//图标类名
